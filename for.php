...
if (!is_numeric($first_num)) {echo "Please enter a numeric value\n";}

if ($first_num = "") {echo "Please enter a numeric value\n";}

fwrite(STDOUT, "Please choose another number\n");

$second_num = trim(fgets(STDIN));

if (!is_numeric($second_num)) {echo "Please enter a numeric value";}	

if ($second_num = "") {echo "Please enter a numeric value";}	
